          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Input Data Pasien <small>different form elements</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" action={{ route('pages.patients.store') }} method="post" data-parsley-validate class="form-horizontal form-label-left">
                      {{ csrf_field() }}
                      ...
                      <div class="form-group has-feedback{{ $errors->has('content') ? ' has-errors' : '' }}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea name="address" rows="5" class="form-control col-md-7 col-xs-12" placeholder="Post address">{{ old('address') }}</textarea>
